...
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h4 class="text-primary font-weight-bold">Add New CMS Page</h4>
        <a href="{{ route('cms.index') }}" class="btn btn-secondary btn-sm">← Back to List</a>
    </div>

    <div class="card shadow">
        <div class="card-body">
            <form id="cmsForm" action="{{ route('cms.store') }}" method="POST" enctype="multipart/form-data">
                @csrf
                ...
                <div class="row">
                    <div class="col-md-6 mb-3">
                        ...
                        <select name="page" class="form-control">
                            ...
                            <option value="About us" {{ old('page') == 'About us' ? 'selected' : '' }}>About Us</option>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="description" id="description" class="form-control summernote" placeholder="Enter page content...">{{ old('description') }}</textarea>
                    @error('description') <small class="text-danger">{{ $message }}</small> @enderror
                </div>

                <div class="text-end">
                    <button type="submit" class="btn btn-primary px-4" id="saveBtn">Save Page</button>
                    <a href="{{ route('cms.index',['page'=>$page]) }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
