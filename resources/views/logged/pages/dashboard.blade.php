...
@section('content')
    ...
    <div class="container-fluid">
        ...
        <div class="row">
            ...
            <!-- Assigned Contracts Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
            ...
            <!-- Completed Contracts Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
            ...
            <!-- Pending Contracts Card Example -->
            <div class="col-xl-3 col-md-6 mb-4">
                    ...
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                ...
                                <div class="h5 mb-0 font-weight-bold text-gray-800">2435</div>
                            </div>
                            <div class="col-auto">
